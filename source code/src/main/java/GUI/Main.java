...
public class Main extends Application {
	...
	public void start(Stage primaryStage) {
		...
		this.primaryStage.setTitle(
				"RCdesign v5.0 - Projektowanie                          autorzy:Tadeusz Miesi¹c, Konrad Markowski, Mateusz Bamberski pod kierunkiem JŒ & MD ");
		initRootLayout();
		loadDesignScene();
		loadDiagnosisScene();
		loadGraphScene();
	...
	public void switchToDiagnosisScene() {
		...
		primaryStage.setTitle(
				"RCdesign v5.0 - Diagnostyka                             autorzy:Tadeusz Miesi¹c, Konrad Markowski, Mateusz Bamberski pod kierunkiem JŒ & MD ");
	...
	public void switchToGraphScene() {
		...
		primaryStage.setTitle(
				"RCdesign v5.0 - Krzywe noœnoœci granicznej     autorzy:Tadeusz Miesi¹c, Konrad Markowski, Mateusz Bamberski pod kierunkiem JŒ & MD ");
