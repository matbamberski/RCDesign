...
public class RequiredReinforcement {
	...
	public void columnRequiredReinforcement(Concrete concrete, Steel steel, InternalForces internalForces,
		 ...
		 * System.out.println("obliczanie s�upa"); System.out.println(""); ///
		 ...
		 * put(key,value) -> entry(mimo�r�d, moment) combinationsMed.put(e1,
		 ...
		 * put(key,value) -> entry(mimo�r�d, normalna) combinationsNed.put(e1,
		 ...
		 * System.err.println("Normalna z max mimo�rodu to: " + n0Ed + "kN"); /* for
		 ...
		 * if (n0Ed != 0.0) {
		 *
		 * double reinforcementRatio1 = 0.0; // stopie� na pocz�tku p�tli double
		 * reinforcementRatio2 = 0.0; // stopie� na ko�cu p�tli double
		 * reinforcementRatio3 = 0.0; // stopie� kt�ry jest �redni�
		 * arytmetyczn� dw�ch powy�szych do por�wnania // z reinforcementRatio2
		 * // ostatecznym
		 *
		 * /// Zbrojenie symetryczne
		 *
		 * double mEd = m0Ed; System.err.println("Moment pocz�tkowy: " + mEd); ///
		 ...
		 * ); } else { /// pobierz stopie� zbrojenia na pocz�tku p�tli
		 ...
		 * dimensions, reinforcement, mEd, n0Ed); // pobiera stopie� zbrojenia na
		 * ko�cu p�tli reinforcementRatio2 = reinforcement.getReinforcementRatio();
		 * reinforcementRatio3 = (reinforcementRatio1 + reinforcementRatio2) / 2.0;
		 *
		 * } else if (n0Ed < 0) { System.out.println("rozci�ganie "); // ROZCIAGANIE ,
		 * W GUI WPROWADZONE Z MINUSEM ALE DO ROWNAN // PODSTAWIONE Z + !!!
